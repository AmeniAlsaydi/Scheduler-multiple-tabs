...
class ScheduleListController: UIViewController {
  ...
  private func update(oldEvent: Event, with newEvent: Event) {
    ...
    // retrive objects from documents directory
    //
  ...
  @IBAction func editButtonPressed(_ sender: UIBarButtonItem) {
    ...
    private func showCreateEvent(_ event: Event? = nil) { // default parameter: event is nil if nothing is passed
        // we need to use the story board to get an instance of the CreateEventController
        // in the case of multiple story board ex) log in story board
        ...
        // let createEC = CreateEventController() // this will not give you an instance of an exsisting VC it will create an empty VC without any outlets - hence the () - and will crash if you are expecting your outlers to worl if they exist in the storyboard
